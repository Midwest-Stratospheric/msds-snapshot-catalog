...
_Generated 2026-09-11 10:44 UTC from open-tier data. Mermaid only — no image binaries._
...
**Last run:** `2026-09-11T10:44:54.219250+00:00` · **13/15 sources OK**

```mermaid
pie showData
  title Ingest sources OK vs failed (13/15)
  "OK" : 13
  "Failed or skipped" : 2
```
